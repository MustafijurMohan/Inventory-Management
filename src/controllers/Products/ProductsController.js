...
const PurchaseProductsModel = require('../../models/Purchases/PurchasesProductsModel')
...
exports.DeleteProduct = async (req, res) => {
    ...
    const CheckReturnAssociate = await CheckAssociateService({ProductID: new ObjectId(DeleteID)}, ReturnProductsModel)
    const CheckPurchaseAssociate = await CheckAssociateService({ProductID: new ObjectId(DeleteID)}, PurchaseProductsModel)
    const CheckSaleAssociate = await CheckAssociateService({ProductID: new ObjectId(DeleteID)}, SaleProductsModel)
