...
export const {SetExpenseChart, SetPurchaseChart, SetReturnChart, SetSaleChart, SetExpenseTotal, SetPurchaseTotal, SetReturnTotal, SetSaleTotal} = dashboardSlice.actions
