                        ...
                        <div className="card-body">
                            ...
                            <div className="row m-0 p-0">
                                ...
                                <div className="col-md-4 p-2">
                                    ...
                                    <input ref={(input) => mobileRef=input} type="number" placeholder='Mobile' className='form-control animated fadeInUp' />
                                </div>
                                <div className="col-md-4 p-2">
                                    <label htmlFor="">Password</label>
                                    <input ref={(input) => passwordRef=input} type="password" placeholder='Password' className='form-control animated fadeInUp' />
                                </div>
                            </div>
                            <div className="row m-0 p-0">
                                <div className="col-md-4 p-2">
                                    <button onClick={onRegistration} className='btn btn-success w-100 mt-2 animated fadeInUp'>Complete</button>
                                </div>
                            </div>
                        </div>
                    </div>
